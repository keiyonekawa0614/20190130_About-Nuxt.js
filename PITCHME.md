...
- @size[0.9em](Twitter: @keiuwk0614)  
- @size[0.9em](所属: 株式会社ITプロパートナーズ)
- @size[0.9em](金融系SIer出身、サーバサイドエンジニア(Java、PHP))
- @size[0.9em](Nuxt(Vue)歴半年ぐらい)
- @size[0.9em](フロントエンドをNuxt.js、サーバサイドをLaravelで自社プロダクト「Graspy」を開発中)

---

### Graspyサービス紹介

@size[0.9em](「学び」と「出会い」を作り出すキャリア形成プラットフォーム)
...
- 技術ブランディングの強化 | 
 - 昨年のVueFesJapan2018にゴールドスポンサーとして協賛し、社内でモダンな技術を取り入れていることの技術ブランディング<br>
- エンジニア採用 |
 - Nuxt(Vue)で開発したいエンジニアから応募がくることが多くなった<br>
